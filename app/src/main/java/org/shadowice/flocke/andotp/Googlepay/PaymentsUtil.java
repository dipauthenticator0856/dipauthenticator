...
package org.shadowice.flocke.andotp.Googlepay;
            ...
            put("parameters", new JSONObject() {
                {
                    ...
                    put("stripe:publishableKey", "pk_test_cSOnNhXUDgbwfTJYETFgezVH00HS3FPf2y");
                }
            });
        }};
    }
 ...
 /*   private static JSONObject getCardPaymentMethod() throws JSONException {
   ...
   /* public static Optional<JSONObject> getIsReadyToPayRequest() {
        try {
            ...
            Log.e("getIsReadyToPayRequest"," "+isReadyToPayRequest);
