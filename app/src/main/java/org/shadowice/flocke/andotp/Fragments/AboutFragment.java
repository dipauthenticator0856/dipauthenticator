...
public class AboutFragment extends Fragment {
    ...
    private static final String GITHUB_URI = "https://github.com/Dip Authenticator/Dip Authenticator";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout linear_support = v.findViewById(R.id.linear_support);
...
//                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://dip.cloud/support.php"));
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.dipauthenticator.com/support.php"));
    ...
    public void copyToClipboard(String uri) {
        ...
        ClipData clip = ClipData.newPlainText("Dip Authenticator", uri);
